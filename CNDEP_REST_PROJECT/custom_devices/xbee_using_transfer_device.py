...
try:
    ...
    from devices.xbee.common.prodid import PROD_DIGI_UNSPECIFIED, \
        ...
        PROD_DIGI_XB_ADAPTER_RS232, PROD_DIGI_XB_ADAPTER_RS485
except: pass
...
class ZigBeeTransferDevice(XBeeBase, threading.Thread):
    ...
    def start(self):
        ...
        print "Starting xbee_using_transfer_device"
        try:
        ...
        xbdm_rx_event_spec_90 = XBeeDeviceManagerRxEventSpec()
        xbdm_rx_event_spec_90.cb_set(self._sample_indication_90)
        xbdm_rx_event_spec_90.match_spec_set(
            (extended_address, 0xe8, 0xc105, 0x90),
            (True, True, True, True))
        self.__xbee_manager.xbee_device_event_spec_add(self,
                                xbdm_rx_event_spec_90)
        
        xbdm_rx_event_spec_91 = XBeeDeviceManagerRxEventSpec()
        xbdm_rx_event_spec_91.cb_set(self._sample_indication_91)
        xbdm_rx_event_spec_91.match_spec_set(
            (extended_address, 0xe8, 0xc105, 0x91),
            (True, True, True, True))
        self.__xbee_manager.xbee_device_event_spec_add(self,
                                xbdm_rx_event_spec_91)
        
        xbdm_rx_event_spec_92 = XBeeDeviceManagerRxEventSpec()
        xbdm_rx_event_spec_92.cb_set(self._sample_indication_92)
        xbdm_rx_event_spec_92.match_spec_set(
            (extended_address, 0xe8, 0xc105, 0x92),
            (True, True, True, True))
        self.__xbee_manager.xbee_device_event_spec_add(self,
                                xbdm_rx_event_spec_92)
        
        xbdm_rx_event_spec_10 = XBeeDeviceManagerRxEventSpec()
        xbdm_rx_event_spec_10.cb_set(self._sample_indication_10)
        xbdm_rx_event_spec_10.match_spec_set(
            (extended_address, 0xe8, 0xc105, 0x10),
            (True, True, True, True))
        self.__xbee_manager.xbee_device_event_spec_add(self,
                                xbdm_rx_event_spec_10)
        
        xbdm_rx_event_spec_11 = XBeeDeviceManagerRxEventSpec()
        xbdm_rx_event_spec_11.cb_set(self._sample_indication_11)
        xbdm_rx_event_spec_11.match_spec_set(
            (extended_address, 0xe8, 0xc105, 0x11),
            (True, True, True, True))
        self.__xbee_manager.xbee_device_event_spec_add(self,
                                xbdm_rx_event_spec_11)
    ...
    def _sample_indication_90(self, buf, addr):
        print '_sample_indication_90'
        try: 
    ...
    def _sample_indication_91(self, buf, addr):
        print '_sample_indication_91'
        try: 
            data = hexlify(str(buf))
            #print 'heXlify data:', data
        except Exception, e : print e
    ...
    def _sample_indication_92(self, buf, addr):
        print '_sample_indication_92'
        try: 
            data = hexlify(str(buf))
            #print 'heXlify data:', data
        except Exception, e : print e
    ...
    def _sample_indication_10(self, buf, addr):
        print '_sample_indication_10'
        try: 
            data = hexlify(str(buf))
            #print 'heXlify data:', data
        except Exception, e : print e
    ...
    def _sample_indication_11(self, buf, addr):
        print '_sample_indication_11'
        try: 
            data = hexlify(str(buf))
            #print 'heXlify data:', data
        except Exception, e : print e
